  ...
  return (
    <>
        ...
        <div>
          <div className="text-center mt-2">
            <div className="fw-bold text-secondary mb-3">
              Are you sure? You want to {action} breakout room
            </div>
            {processing ? (
              <img
                src={loadingGif}
              ...
              <button
                ...
                onClick={() => sendEvent({ name: "bor", action })}
              >
                Yes
              </button>
            )}
      ...
      <div className="col border p-3 me-2">
        <div className="fw-bold">Breakout Room</div>
        ...
        <div className="mt-3">
          <div
            ...
            onClick={() =>
              clickable ? handleEvent("join") : console.log("please wait...")
            }
          >
            Join
          </div>
          <div
            className="btn btn-secondary"
            onClick={() =>
              clickable ? handleEvent("leave") : console.log("please wait...")
            }
          >
            Leave
          </div>
